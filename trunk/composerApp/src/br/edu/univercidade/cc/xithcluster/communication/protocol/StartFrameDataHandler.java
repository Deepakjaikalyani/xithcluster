...
public class StartFrameDataHandler extends ChainedSafeDataHandler<ComposerProtocolHandler> {

	private int frameIndex;
	
	public StartFrameDataHandler(ComposerProtocolHandler nextDataHandler) {
