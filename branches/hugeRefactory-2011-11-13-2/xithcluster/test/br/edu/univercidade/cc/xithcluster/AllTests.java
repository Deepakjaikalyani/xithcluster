...
@RunWith(Suite.class)
@SuiteClasses({
BufferUtilsTest.class, SerializerTester.class, TransformGroupSerializerTest.class, GroupSerializerTest.class, BranchGroupSerializerTest.class,
SerializationHelperTest.class, PixelBufferTest.class, ImageOrderAndZBufferStrategyTest.class
})
