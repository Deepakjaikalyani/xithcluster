...
/**
 * Created by IntelliJ IDEA. User: stevcc Date: 11-Jun-2003 Time: 19:08:11 To
...
public class Gui extends JFrame {
	...
	private List<DocumentGeneratorGui> generatorGuis = new ArrayList<DocumentGeneratorGui>();
	...
	private ActionListener goActionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			for (DocumentGeneratorGui gui : generatorGuis) {
				if (gui.isConfigured()) {
